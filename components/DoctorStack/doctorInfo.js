    ...
    render(){
        return(
            <ScrollView style={styles.container}>
                <ImageBackground  source={require("./../../assets/images/Background.png")} style={{flex:1}} imageStyle={{opacity:0.5}} >
                ...
                <View style={{marginTop:27,padding:5}}>
                {this.state.data.map((item)=>
                    {
                    return (
                    
                        <View style={{flexDirection:"row",paddingVertical:7,paddingHorizontal:10,borderRadius:7}}>
